...
import gonfc "github.com/maitredede/gonfc"
...
var pn53xRegisters map[Register]string = map[Register]string{
	PN53X_REG_CIU_Mode:        "Defines general modes for transmitting and receiving",
	PN53X_REG_CIU_TxMode:      "Defines the transmission data rate and framing during transmission",
	PN53X_REG_CIU_RxMode:      "Defines the transmission data rate and framing during receiving",
	PN53X_REG_CIU_TxControl:   "Controls the logical behaviour of the antenna driver pins TX1 and TX2",
	PN53X_REG_CIU_TxAuto:      "Controls the settings of the antenna driver",
	PN53X_REG_CIU_TxSel:       "Selects the internal sources for the antenna driver",
	PN53X_REG_CIU_RxSel:       "Selects internal receiver settings",
	PN53X_REG_CIU_RxThreshold: "Selects thresholds for the bit decoder",
	PN53X_REG_CIU_Demod:       "Defines demodulator settings",
	PN53X_REG_CIU_FelNFC1:     "Defines the length of the valid range for the received frame",
	PN53X_REG_CIU_FelNFC2:     "Defines the length of the valid range for the received frame",
	PN53X_REG_CIU_MifNFC:      "Controls the communication in ISO/IEC 14443/MIFARE and NFC target mode at 106 kbit/s",
	PN53X_REG_CIU_ManualRCV:   "Allows manual fine tuning of the internal receiver",
	PN53X_REG_CIU_TypeB:       "Configure the ISO/IEC 14443 type B",
	// PNREG (PN53X_REG_-, "Reserved"),
	// PNREG (PN53X_REG_-, "Reserved"),
	PN53X_REG_CIU_CRCResultMSB:   "Shows the actual MSB values of the CRC calculation",
	PN53X_REG_CIU_CRCResultLSB:   "Shows the actual LSB values of the CRC calculation",
	PN53X_REG_CIU_GsNOFF:         "Selects the conductance of the antenna driver pins TX1 and TX2 for load modulation when own RF field is switched OFF",
	PN53X_REG_CIU_ModWidth:       "Controls the setting of the width of the Miller pause",
	PN53X_REG_CIU_TxBitPhase:     "Bit synchronization at 106 kbit/s",
	PN53X_REG_CIU_RFCfg:          "Configures the receiver gain and RF level",
	PN53X_REG_CIU_GsNOn:          "Selects the conductance of the antenna driver pins TX1 and TX2 for modulation, when own RF field is switched ON",
	PN53X_REG_CIU_CWGsP:          "Selects the conductance of the antenna driver pins TX1 and TX2 when not in modulation phase",
	PN53X_REG_CIU_ModGsP:         "Selects the conductance of the antenna driver pins TX1 and TX2 when in modulation phase",
	PN53X_REG_CIU_TMode:          "Defines settings for the internal timer",
	PN53X_REG_CIU_TPrescaler:     "Defines settings for the internal timer",
	PN53X_REG_CIU_TReloadVal_hi:  "Describes the 16-bit long timer reload value (Higher 8 bits)",
	PN53X_REG_CIU_TReloadVal_lo:  "Describes the 16-bit long timer reload value (Lower 8 bits)",
	PN53X_REG_CIU_TCounterVal_hi: "Describes the 16-bit long timer actual value (Higher 8 bits)",
	PN53X_REG_CIU_TCounterVal_lo: "Describes the 16-bit long timer actual value (Lower 8 bits)",
	// PNREG (PN53X_REG_-, "Reserved"),
	PN53X_REG_CIU_TestSel1:     "General test signals configuration",
	PN53X_REG_CIU_TestSel2:     "General test signals configuration and PRBS control",
	PN53X_REG_CIU_TestPinEn:    "Enables test signals output on pins.",
	PN53X_REG_CIU_TestPinValue: "Defines the values for the 8-bit parallel bus when it is used as I/O bus",
	PN53X_REG_CIU_TestBus:      "Shows the status of the internal test bus",
	PN53X_REG_CIU_AutoTest:     "Controls the digital self-test",
	PN53X_REG_CIU_Version:      "Shows the CIU version",
	PN53X_REG_CIU_AnalogTest:   "Controls the pins AUX1 and AUX2",
	PN53X_REG_CIU_TestDAC1:     "Defines the test value for the TestDAC1",
	PN53X_REG_CIU_TestDAC2:     "Defines the test value for the TestDAC2",
	PN53X_REG_CIU_TestADC:      "Show the actual value of ADC I and Q",
	// PNREG (PN53X_REG_-, "Reserved for tests"),
	// PNREG (PN53X_REG_-, "Reserved for tests"),
	// PNREG (PN53X_REG_-, "Reserved for tests"),
	PN53X_REG_CIU_RFlevelDet: "Power down of the RF level detector",
	PN53X_REG_CIU_SIC_CLK_en: "Enables the use of secure IC clock on P34 / SIC_CLK",
	PN53X_REG_CIU_Command:    "Starts and stops the command execution",
	PN53X_REG_CIU_CommIEn:    "Control bits to enable and disable the passing of interrupt requests",
	PN53X_REG_CIU_DivIEn:     "Controls bits to enable and disable the passing of interrupt requests",
	PN53X_REG_CIU_CommIrq:    "Contains common CIU interrupt request flags",
	PN53X_REG_CIU_DivIrq:     "Contains miscellaneous interrupt request flags",
	PN53X_REG_CIU_Error:      "Error flags showing the error status of the last command executed",
	PN53X_REG_CIU_Status1:    "Contains status flags of the CRC, Interrupt Request System and FIFO buffer",
	PN53X_REG_CIU_Status2:    "Contain status flags of the receiver, transmitter and Data Mode Detector",
	PN53X_REG_CIU_FIFOData:   "In- and output of 64 byte FIFO buffer",
	PN53X_REG_CIU_FIFOLevel:  "Indicates the number of bytes stored in the FIFO",
	PN53X_REG_CIU_WaterLevel: "Defines the thresholds for FIFO under- and overflow warning",
	PN53X_REG_CIU_Control:    "Contains miscellaneous control bits",
	PN53X_REG_CIU_BitFraming: "Adjustments for bit oriented frames",
	PN53X_REG_CIU_Coll:       "Defines the first bit collision detected on the RF interface",

	// SFR
	PN53X_SFR_P3CFGA: "Port 3 configuration",
	PN53X_SFR_P3CFGB: "Port 3 configuration",
	PN53X_SFR_P3:     "Port 3 value",
	PN53X_SFR_P7CFGA: "Port 7 configuration",
	PN53X_SFR_P7CFGB: "Port 7 configuration",
	PN53X_SFR_P7:     "Port 7 value",
}
